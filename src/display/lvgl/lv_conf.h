 ...
 * Enabled via the LVGL_PORT_ENABLE_PERF_MONITOR build flag (debug env).*/
#ifndef LVGL_PORT_ENABLE_PERF_MONITOR
    #define LVGL_PORT_ENABLE_PERF_MONITOR 0
#endif
#define LV_USE_PERF_MONITOR LVGL_PORT_ENABLE_PERF_MONITOR
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_montserrat_italic_96)
